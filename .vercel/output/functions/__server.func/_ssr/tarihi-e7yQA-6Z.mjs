...
//#region node_modules/.nitro/vite/services/ssr/assets/tarihi-e7yQA-6Z.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Yarımada ve iskeleler"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "mt-2 font-display text-display font-medium tracking-tight",
				children: "Tarihi mekanlar"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-3 max-w-2xl text-lead text-muted",
				children: "Cami, sur, çarşı, hisar ve mahalle. Çoğu ücretsiz; namaz vakitlerinde iç mekan sınırlıdır."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchField, {
						value: q,
						onChange: setQ,
						placeholder: "Mekan veya mahalle ara"
					})
...
//#endregion
export { HistoricPage as component };
